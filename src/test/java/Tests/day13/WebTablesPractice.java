...
//    }
/*
//table[@id='table1']  ==> table itself
//table[@id='table1']/thead   ==> localte the head
//table[@id='table1']/tbody   ==> locate the table body
//table[@id='table1']/thead/tr/th[1]   ==> last name
//table[@id='table1']/thead//th[1]  ==> last name
//table[@id='table1']/thead//th[3]
//table[@id='table1']/thead//th    ==> it matches with 6 eleemts
findElement
findElements == //table[@id='table1']/thead//th
//table//thead[1]/tr   ==> table head which included all heads(th)
//table//thead[1]/tr/th[2]  ==> tags
//table[@id='table1']//tr     ==> locate all tr includes thead and tbody
<table>
    <thead>
        <tr>
          <th>
    ...
    <tbody>
        ...
        <tr>
        <tr>
//table[@id='table1']/tbody/tr[3]//td[2] ==> jason
        //table[@id='table1']/tbody/tr[4] ==> 1st row in tbody
//table[@id='table1']/thead//tr   ==>  locate only first line/row
//table[@id='table1']/tbody//tr  ==> not including thead
//table[@id='table1']/tbody/tr[i]
 */